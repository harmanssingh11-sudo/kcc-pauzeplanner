...
function buildPlan(people,date){
 ...
 ['mini1','mini2'].forEach(kind=>{
  ...
  // Fase 1: eerst echte duo's. Exact dezelfde start is toegestaan; 5-min overlap nooit.
...
const PauzeEngine={DAYS,BIG_SLOTS,toMin,toHHMM,emptyWeek,weekdayOf,scheduleFor,isEligible,rightsFor,mini1Window,overlaps,respectsMiniBuffer,buildPlan};if(typeof module!=='undefined'&&module.exports)module.exports=PauzeEngine;else window.PauzeEngine=PauzeEngine;